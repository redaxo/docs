...
> **Hinweis:** Die Daten sollten in der weiteren Verarbeitung "gesäubert" werden. Zum Beispiel sollten mit *rex_get*, *rex_post* und *rex_request* übernommene Strings vor der Ausgabe auf der Website mit *rex_escape()* bearbeitet werden, um mögliches HTML umzuwandeln. Damit wird Cross-Site-Scripting (XSS) verhindert.
