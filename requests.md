...
> **Hinweis:** Die Daten sollten in der weiteren Verarbeitung "gesäubert" werden. Z.B. sollte mit rex_get, rex_post und rex_request übernommenen Strings vor der Ausgabe auf der Website mit htmlspecialchars($string, ENT_QUOTES, ‘UTF-8’) bearbeitet werden, um mögliches HTML umzuwandeln. Damit wird Cross-Site-Scripting (XSS) zu verhindert.
