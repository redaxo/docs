...
- Anwender
    ...
    - [Redaktion](/{{path}}/{{version}}/redaktion) <sup><b>offen</b></sup>
...
- Service
    ...
    - [REX_VARs <sup>(List, Anwendung, eigene Vars erstellen)</sup>](/{{path}}/{{version}}/redaxo-variablen) <sup><b>in Bearbeitung</b></sup> <sup><i>Daniel</i></sup>
